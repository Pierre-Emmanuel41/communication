...
public interface IConnection {
    ...
    /**
     * First step for initializing this connection. This method is called before
     ...
     * independent of the connection state with the remote.
     */
    boolean isEnabled();
     ...
     * {@link #send(IMessage)} will not stores the message.
     *
    ...
    /**
     * @return true if this connection has been disposed and cannot be used anymore,
     * false otherwise.
     */
    boolean isDisposed();
