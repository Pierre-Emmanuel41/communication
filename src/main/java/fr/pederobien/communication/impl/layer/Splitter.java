...
public class Splitter {
	...
	/**
	 * Creates a splitter. If the size of a data is greater than the maximum value, the data is split into different packet.
	 *
	...
	/**
	 * Creates one or more packets from the input data depending upon the data size is greater than a specific value.
	 *
	 * @param ID   The ID of the packet.
	 * @param data The bytes array to split if necessary.
	 * @return A list of packets corresponding the to split array with additional information.
	 */
	...
	/**
	 * If a request is already registered for the given ID, the payload is added at the end of the previous payload. When the value of
	 * current correspond to total - 1, all the packets have been received. The request has been received entirely and can be used. If
	 * no request has been received for the given ID, the payload will be stored until a new packet is received.
	 *
