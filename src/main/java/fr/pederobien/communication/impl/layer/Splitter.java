...
public class Splitter {
	...
	/**
	 * Creates a splitter. If the size of a data is greater than the maximum value, the data
	 * is split into different packet.
	 * 
	...
	/**
	 * Creates one or more packets from the input data depending if the data size is greater than
	 * a specific value.
	 * 
