...
public class LayerInitializer implements ILayerInitializer {
	...
	/**
	 * Creates a layer initializer using a simple layer as layer to perform initialisation.
	 *
	 * @param steps A sequence to perform additional steps during initialisation.
	 */
	...
	/**
	 * Creates a layer initializer with no initialisation sequence. The given layer should not need to exchange information with the
	 * remote.
	 *
	...
	/**
	 * Creates a layer initializer for a {@link SimpleLayer} The given layer should not need to exchange information with the remote.
	 */
