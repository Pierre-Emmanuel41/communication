...
public class HeaderMessage implements IHeaderMessage {
	...
	/**
	 * Create a header of a message. In case the message is a response to another
	 * request, the requestID must be the original request identifier. It should be
	 * set to 0 when the message is not a response.
	 * 
